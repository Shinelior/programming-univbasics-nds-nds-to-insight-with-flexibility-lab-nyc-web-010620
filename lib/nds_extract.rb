...
def gross_per_studio(collection)
  ...
  #while column_index<collection[row_index][:movies].length do
   # studio_name=collection[row_index][:movies][column_index][:studio]
    #tempelt=studio_name
   #studio_namet=collection[row_index+1][:studio]
   # studio_name=
...
def movies_with_directors_set(source)
  ...
  #director_name=source[row_index][:name]
   ...
   new_hash[row_index][:director_name]+=source[row_index][:movies]
 end
   
      #director_name=source[row_index][:name]
   # movie_title=source[row_index][:movies]
      #new_hash[:movies]= movie_title
      #new_hash[:director_name]=director_name
